...
<div align="center"> 🚀 Welcome to my git repo :<b>Text Summarization</b></div>

#####   
<img src="https://github.com/himalayaashish/Text_Summarizer/blob/main/work-2.png?raw=true" alt="Text Summarization" width="500"/>


#### Text Summarization Using Transformer Models
###### This project demonstrates how to leverage transformer-based models to perform text summarization on conversation data using the Hugging Face transformers library.A pre-trained BART-large-XSum model is utilized to summarize long conversations. The summarizer is optimized to run on a GPU, ensuring fast inference and efficient tokenization handling. The project showcases how to generate concise and meaningful summaries of dialogues.
